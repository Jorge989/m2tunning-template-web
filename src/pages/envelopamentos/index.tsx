...
export function Envelopamentos() {
      ...
      <Container>
        <Textos>
          ...
          <p className="paragrafo-desktop">
            ...
            altere sua <br /> opção de cor acabamento ou mesmo removea pelicula
            futuramente
            <br />
          ...
          <p className="paragrafo-mobile">
            O envelopamento garante que seu carro fique ainda mais bonito
            diferenciado e cheio de estilo, além de permitir que você altere sua
            opção de cor acabamento ou mesmo removea pelicula futuramente sem
            danificar a pintura original do seu veículo.
          </p>
        </Textos>
